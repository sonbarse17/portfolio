...
import { SiJenkins, SiDocker, SiAmazonaws, SiTerraform, SiAngular, SiSpring, SiGooglecloud } from 'react-icons/si';
          ...
          <div className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-md border border-white/30 dark:border-gray-600/30 rounded-2xl shadow-2xl p-8 mb-6 transition-colors duration-300">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              ...
              <div className="mt-4 md:mt-0">
                <span className="inline-block bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm font-medium">Previous Role</span>
              </div>
            </div>
      ...
      content: (
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-md border border-white/30 dark:border-gray-600/30 rounded-2xl shadow-2xl p-8 mb-6 transition-colors duration-300">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              <div>
                <h3 className="heading-md text-gray-800 dark:text-white mb-2 transition-colors duration-300">Freelance DevOps Consultant</h3>
                <p className="body-md text-primary-600 font-semibold">Self-Employed</p>
                <p className="body-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">Remote • 2025 - Present</p>
              </div>
              <div className="mt-4 md:mt-0">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-white mb-3 transition-colors duration-300">🚀 Key Achievements</h4>
                <ul className="space-y-2 text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  <li className="flex items-start"><span className="text-primary-500 mr-2">•</span>CI/CD Pipeline Setup & Optimization</li>
                  <li className="flex items-start"><span className="text-primary-500 mr-2">•</span>Cloud Infrastructure Design & Management</li>
                  <li className="flex items-start"><span className="text-primary-500 mr-2">•</span>Kubernetes Consulting & Implementation</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-white mb-3 transition-colors duration-300">🛠️ Tech Stack</h4>
                <div className="flex flex-wrap gap-2">
                  <span className="flex items-center gap-1 px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm"><SiAmazonaws size={14} />AWS</span>
                  <span className="flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm"><SiGooglecloud size={14} />GCP</span>
                  <span className="flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm"><VscAzure size={14} />Azure</span>
                  <span className="flex items-center gap-1 px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm"><SiTerraform size={14} />Terraform</span>
                  <span className="flex items-center gap-1 px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm"><SiJenkins size={14} />Jenkins</span>
                  <span className="flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm"><SiDocker size={14} />Docker</span>
                </div>
