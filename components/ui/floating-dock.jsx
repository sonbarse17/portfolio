...
const FloatingDockDesktop = ({ items, className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 shadow-lg px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="aspect-square rounded-full bg-white/30 backdrop-blur-md border border-white/40 flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
